...
destination = FactoryGirl.create(:location, name: "Lincoln Park Zoo", lat: "41.9166368", lng: "-87.6349685", direction: "West")
...
route.route_runs.create!(bus: bus, run_datetime: 7.hours.from_now, times: "10:15p,10:30p,10:45p,10:00p")
